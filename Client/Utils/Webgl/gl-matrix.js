!(function (t, n) {
  ...
  var e = Object.freeze({
    ...
    create: function () {
      var t = new d(4);
      return (
        d != Float32Array && ((t[1] = 0), (t[2] = 0)), (t[0] = 1), (t[3] = 1), t
      );
    },
    clone: function (t) {
      var n = new d(4);
    ...
    equals: function (t, n) {
      var a = t[0],
        ...
        n = n[3];
      return (
        Math.abs(a - o) <= E * Math.max(1, Math.abs(a), Math.abs(o)) &&
        Math.abs(r - i) <= E * Math.max(1, Math.abs(r), Math.abs(i)) &&
        Math.abs(u - t) <= E * Math.max(1, Math.abs(u), Math.abs(t)) &&
        Math.abs(e - n) <= E * Math.max(1, Math.abs(e), Math.abs(n))
      );
    },
  ...
  var h = Object.freeze({
    ...
    create: function () {
      var t = new d(6);
      return (
        d != Float32Array && ((t[1] = 0), (t[2] = 0), (t[4] = 0), (t[5] = 0)),
        (t[0] = 1),
        (t[3] = 1),
        t
      );
    ...
    equals: function (t, n) {
      var a = t[0],
        ...
        n = n[5];
      return (
        Math.abs(a - h) <= E * Math.max(1, Math.abs(a), Math.abs(h)) &&
        Math.abs(r - c) <= E * Math.max(1, Math.abs(r), Math.abs(c)) &&
        Math.abs(u - s) <= E * Math.max(1, Math.abs(u), Math.abs(s)) &&
        Math.abs(e - M) <= E * Math.max(1, Math.abs(e), Math.abs(M)) &&
        Math.abs(o - t) <= E * Math.max(1, Math.abs(o), Math.abs(t)) &&
        Math.abs(i - n) <= E * Math.max(1, Math.abs(i), Math.abs(n))
      );
    },
    mul: o,
    sub: i,
  ...
  var l = Object.freeze({
    ...
    equals: function (t, n) {
      var a = t[0],
        ...
        n = n[8];
      return (
        Math.abs(a - M) <= E * Math.max(1, Math.abs(a), Math.abs(M)) &&
        Math.abs(r - f) <= E * Math.max(1, Math.abs(r), Math.abs(f)) &&
        Math.abs(u - l) <= E * Math.max(1, Math.abs(u), Math.abs(l)) &&
        Math.abs(e - v) <= E * Math.max(1, Math.abs(e), Math.abs(v)) &&
        Math.abs(o - b) <= E * Math.max(1, Math.abs(o), Math.abs(b)) &&
        Math.abs(i - m) <= E * Math.max(1, Math.abs(i), Math.abs(m)) &&
        Math.abs(h - d) <= E * Math.max(1, Math.abs(h), Math.abs(d)) &&
        Math.abs(c - t) <= E * Math.max(1, Math.abs(c), Math.abs(t)) &&
        Math.abs(s - n) <= E * Math.max(1, Math.abs(s), Math.abs(n))
      );
    },
    mul: M,
    sub: f,
  ...
  function b(t, n, a) {
    ...
    return (
      ...
      (t[8] = x * r + y * i + q * M + n * b),
      (t[9] = x * u + y * h + q * f + n * m),
      (t[10] = x * e + y * c + q * l + n * d),
      (t[11] = x * o + y * s + q * v + n * p),
      (x = a[12]),
      (y = a[13]),
      (q = a[14]),
      (n = a[15]),
      (t[12] = x * r + y * i + q * M + n * b),
      (t[13] = x * u + y * h + q * f + n * m),
      (t[14] = x * e + y * c + q * l + n * d),
      (t[15] = x * o + y * s + q * v + n * p),
      t
    );
  }
    ...
    return (
      0 < n
        ? ((e = 2 * Math.sqrt(1 + n)),
          ...
          (t[2] = (i - c) / e))
        : s < o && u < o
          ? ((e = 2 * Math.sqrt(1 + o - s - u)),
            (t[3] = (M - r) / e),
            (t[0] = 0.25 * e),
            (t[1] = (i + c) / e),
            (t[2] = (a + h) / e))
          : u < s
            ? ((e = 2 * Math.sqrt(1 + s - o - u)),
              (t[3] = (a - h) / e),
              (t[0] = (i + c) / e),
              (t[1] = 0.25 * e),
              (t[2] = (M + r) / e))
            : ((e = 2 * Math.sqrt(1 + u - o - s)),
              (t[3] = (i - c) / e),
              (t[0] = (a + h) / e),
              (t[1] = (M + r) / e),
              (t[2] = 0.25 * e)),
  ...
  var A = Object.freeze({
    ...
    translate: function (t, n, a) {
      ...
      return (
        n === t
          ? ((t[12] = n[0] * v + n[4] * b + n[8] * m + n[12]),
            (t[13] = n[1] * v + n[5] * b + n[9] * m + n[13]),
            (t[14] = n[2] * v + n[6] * b + n[10] * m + n[14]),
            (t[15] = n[3] * v + n[7] * b + n[11] * m + n[15]))
          : ((r = n[0]),
            (u = n[1]),
            (e = n[2]),
            (o = n[3]),
            ...
            (t[10] = l),
            (t[11] = a),
            (t[12] = r * v + i * b + M * m + n[12]),
            (t[13] = u * v + h * b + f * m + n[13]),
            (t[14] = e * v + c * b + l * m + n[14]),
            (t[15] = o * v + s * b + a * m + n[15])),
        t
      );
    },
    scale: function (t, n, a) {
    ...
    fromRotationTranslationScaleOrigin: function (t, n, a, r, u) {
      ...
      return (
        ...
        (t[10] = c),
        (t[11] = 0),
        (t[12] = a[0] + s - (r * s + e * h + n * M)),
        (t[13] = a[1] + h - (u * s + d * h + p * M)),
        (t[14] = a[2] + M - (o * s + i * h + c * M)),
        (t[15] = 1),
        t
      );
    },
    ...
    lookAt: function (t, n, a, r) {
      var u,
        ...
        f = a[1],
        l = a[2];
      return Math.abs(e - M) < E && Math.abs(o - f) < E && Math.abs(i - l) < E
        ? v(t)
        : ((u = e - M),
          (n = o - f),
          (r = i - l),
          (M = c * (r *= a = 1 / Math.hypot(u, n, r)) - s * (n *= a)),
          (f = s * (u *= a) - h * r),
          (l = h * n - c * u),
          (a = Math.hypot(M, f, l))
            ? ((M *= a = 1 / a), (f *= a), (l *= a))
    ...
    equals: function (t, n) {
      var a = t[0],
        ...
        n = n[15];
      return (
        Math.abs(a - p) <= E * Math.max(1, Math.abs(a), Math.abs(p)) &&
        Math.abs(r - x) <= E * Math.max(1, Math.abs(r), Math.abs(x)) &&
        Math.abs(u - y) <= E * Math.max(1, Math.abs(u), Math.abs(y)) &&
        Math.abs(e - q) <= E * Math.max(1, Math.abs(e), Math.abs(q)) &&
        Math.abs(o - g) <= E * Math.max(1, Math.abs(o), Math.abs(g)) &&
        Math.abs(i - _) <= E * Math.max(1, Math.abs(i), Math.abs(_)) &&
        Math.abs(h - A) <= E * Math.max(1, Math.abs(h), Math.abs(A)) &&
        Math.abs(c - w) <= E * Math.max(1, Math.abs(c), Math.abs(w)) &&
        Math.abs(s - R) <= E * Math.max(1, Math.abs(s), Math.abs(R)) &&
        Math.abs(M - z) <= E * Math.max(1, Math.abs(M), Math.abs(z)) &&
        Math.abs(f - O) <= E * Math.max(1, Math.abs(f), Math.abs(O)) &&
        Math.abs(l - j) <= E * Math.max(1, Math.abs(l), Math.abs(j)) &&
        Math.abs(v - P) <= E * Math.max(1, Math.abs(v), Math.abs(P)) &&
        Math.abs(b - S) <= E * Math.max(1, Math.abs(b), Math.abs(S)) &&
        Math.abs(m - t) <= E * Math.max(1, Math.abs(m), Math.abs(t)) &&
        Math.abs(d - n) <= E * Math.max(1, Math.abs(d), Math.abs(n))
      );
    },
    mul: b,
    sub: _,
  ...
  function L(t, n, a) {
    var r = n[0],
      ...
      a = a[2];
    return (
      (t[0] = u * a - e * n), (t[1] = e * o - r * a), (t[2] = r * n - u * o), t
    );
  }
  var V,
    Q = O,
    ...
    W = Object.freeze({
      ...
      hermite: function (t, n, a, r, u, e) {
        var o = e * e,
          ...
          e = o * (3 - 2 * e);
        return (
          (t[0] = n[0] * i + a[0] * h + r[0] * c + u[0] * e),
          (t[1] = n[1] * i + a[1] * h + r[1] * c + u[1] * e),
          (t[2] = n[2] * i + a[2] * h + r[2] * c + u[2] * e),
          t
        );
      },
      bezier: function (t, n, a, r, u, e) {
        var o = 1 - e,
          ...
          e = h * e;
        return (
          (t[0] = n[0] * c + a[0] * i + r[0] * o + u[0] * e),
          (t[1] = n[1] * c + a[1] * i + r[1] * o + u[1] * e),
          (t[2] = n[2] * c + a[2] * i + r[2] * o + u[2] * e),
          t
        );
      },
      random: function (t, n) {
      ...
      transformMat4: function (t, n, a) {
        ...
        return (
          (t[0] = (a[0] * r + a[4] * u + a[8] * e + a[12]) / (n = n || 1)),
          (t[1] = (a[1] * r + a[5] * u + a[9] * e + a[13]) / n),
          (t[2] = (a[2] * r + a[6] * u + a[10] * e + a[14]) / n),
          t
        );
      },
      transformMat3: function (t, n, a) {
        var r = n[0],
          ...
          n = n[2];
        return (
          (t[0] = r * a[0] + u * a[3] + n * a[6]),
          (t[1] = r * a[1] + u * a[4] + n * a[7]),
          (t[2] = r * a[2] + u * a[5] + n * a[8]),
          t
        );
      },
      ...
      equals: function (t, n) {
        var a = t[0],
          ...
          n = n[2];
        return (
          Math.abs(a - e) <= E * Math.max(1, Math.abs(a), Math.abs(e)) &&
          Math.abs(r - t) <= E * Math.max(1, Math.abs(r), Math.abs(t)) &&
          Math.abs(u - n) <= E * Math.max(1, Math.abs(u), Math.abs(n))
        );
      },
      sub: Q,
      mul: Y,
  ...
  function C() {
    var t = new d(4);
    return (
      d != Float32Array && ((t[0] = 0), (t[1] = 0), (t[2] = 0), (t[3] = 0)), t
    );
  }
    ...
    gt = Object.freeze({
      ...
      transformMat4: function (t, n, a) {
        var r = n[0],
          ...
          n = n[3];
        return (
          (t[0] = a[0] * r + a[4] * u + a[8] * e + a[12] * n),
          (t[1] = a[1] * r + a[5] * u + a[9] * e + a[13] * n),
          (t[2] = a[2] * r + a[6] * u + a[10] * e + a[14] * n),
          (t[3] = a[3] * r + a[7] * u + a[11] * e + a[15] * n),
          t
        );
      },
      transformQuat: function (t, n, a) {
  ...
  function _t() {
    var t = new d(4);
    return (
      d != Float32Array && ((t[0] = 0), (t[1] = 0), (t[2] = 0)), (t[3] = 1), t
    );
  }
    ...
    return (
      0 < e
        ? ((u = Math.sqrt(e + 1)),
          ...
          (t[2] = (n[1] - n[3]) * u))
        : (n[4] > n[(a = 0)] && (a = 1),
          (r = ((a = n[8] > n[3 * a + a] ? 2 : a) + 1) % 3),
          (e = (a + 2) % 3),
          (u = Math.sqrt(n[3 * a + a] - n[3 * r + r] - n[3 * e + e] + 1)),
          (t[a] = 0.5 * u),
          (t[3] = (n[3 * r + e] - n[3 * e + r]) * (u = 0.5 / u)),
          (t[r] = (n[3 * r + a] + n[3 * a + r]) * u),
          (t[e] = (n[3 * e + a] + n[3 * a + e]) * u)),
      t
    );
  }
  var Tt,
    ...
    yt =
      ...
      function (t, n, a, r, u, e) {
        return (
          St(It, n, u, e), St(Lt, a, r, e), St(t, It, Lt, 2 * e * (1 - e)), t
        );
      }),
    qt =
      ((Vt = s()),
    ...
    vt = Object.freeze({
      ...
      calculateW: function (t, n) {
        ...
        return (
          ...
          (t[1] = r),
          (t[2] = n),
          (t[3] = Math.sqrt(Math.abs(1 - a * a - r * r - n * n))),
          t
        );
      },
      exp: jt,
      ...
      random: function (t) {
        ...
        return (
          ...
          (t[2] = n * Math.sin(2 * Math.PI * r)),
          (t[3] = n * Math.cos(2 * Math.PI * r)),
          t
        );
      },
      invert: function (t, n) {
        var a = n[0],
          ...
          n = n ? 1 / n : 0;
        return (
          (t[0] = -a * n), (t[1] = -r * n), (t[2] = -u * n), (t[3] = e * n), t
        );
      },
  ...
  function kt(t, n, a) {
    ...
    return (
      ...
      (t[2] = e * a + o * n + r * m - u * b),
      (t[3] = o * a - r * b - u * m - e * n),
      (t[4] = r * s + o * i + u * c - e * h + M * a + v * b + f * n - l * m),
      (t[5] = u * s + o * h + e * i - r * c + f * a + v * m + l * b - M * n),
      (t[6] = e * s + o * c + r * h - u * i + l * a + v * n + M * m - f * b),
      (t[7] = o * s - r * i - u * h - e * c + v * a - M * b - f * m - l * n),
      t
    );
  }
  var Ut = Zt,
    ...
    mt = Object.freeze({
      ...
      getTranslation: function (t, n) {
        var a = n[4],
          ...
          n = n[3];
        return (
          (t[0] = 2 * (a * n + e * o + r * h - u * i)),
          (t[1] = 2 * (r * n + e * i + u * o - a * h)),
          (t[2] = 2 * (u * n + e * h + a * i - r * o)),
          t
        );
      },
      translate: function (t, n, a) {
      ...
      equals: function (t, n) {
        var a = t[0],
          ...
          n = n[7];
        return (
          Math.abs(a - s) <= E * Math.max(1, Math.abs(a), Math.abs(s)) &&
          Math.abs(r - M) <= E * Math.max(1, Math.abs(r), Math.abs(M)) &&
          Math.abs(u - f) <= E * Math.max(1, Math.abs(u), Math.abs(f)) &&
          Math.abs(e - l) <= E * Math.max(1, Math.abs(e), Math.abs(l)) &&
          Math.abs(o - v) <= E * Math.max(1, Math.abs(o), Math.abs(v)) &&
          Math.abs(i - b) <= E * Math.max(1, Math.abs(i), Math.abs(b)) &&
          Math.abs(h - t) <= E * Math.max(1, Math.abs(h), Math.abs(t)) &&
          Math.abs(c - n) <= E * Math.max(1, Math.abs(c), Math.abs(n))
        );
      },
    });
    ...
    U = Object.freeze({
      ...
      transformMat4: function (t, n, a) {
        var r = n[0],
          n = n[1];
        return (
          (t[0] = a[0] * r + a[4] * n + a[12]),
          (t[1] = a[1] * r + a[5] * n + a[13]),
          t
        );
      },
      rotate: function (t, n, a, r) {
      ...
      equals: function (t, n) {
        var a = t[0],
          ...
          n = n[1];
        return (
          Math.abs(a - t) <= E * Math.max(1, Math.abs(a), Math.abs(t)) &&
          Math.abs(r - n) <= E * Math.max(1, Math.abs(r), Math.abs(n))
        );
      },
      len: dt,
      sub: pt,
